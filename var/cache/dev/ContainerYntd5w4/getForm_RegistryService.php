...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Form\\CommentaireAdminType' => ['privates', 'App\\Form\\CommentaireAdminType', 'getCommentaireAdminTypeService', true],
            ...
            'App\\Form\\GouvernoratType' => ['privates', 'App\\Form\\GouvernoratType', 'getGouvernoratTypeService', true],
            'App\\Form\\HotelType' => ['privates', 'App\\Form\\HotelType', 'getHotelTypeService', true],
            'App\\Form\\ParticipationActivityType' => ['privates', 'App\\Form\\ParticipationActivityType', 'getParticipationActivityTypeService', true],
            'App\\Form\\ParticipationEventType' => ['privates', 'App\\Form\\ParticipationEventType', 'getParticipationEventTypeService', true],
            ...
            'App\\Form\\RateHotelType' => ['privates', 'App\\Form\\RateHotelType', 'getRateHotelTypeService', true],
            ...
            'App\\Form\\CommentaireAdminType' => '?',
            'App\\Form\\CommentaireType' => '?',
            'App\\Form\\EvenementType' => '?',
            'App\\Form\\GouvernoratType' => '?',
            'App\\Form\\HotelType' => '?',
            'App\\Form\\ParticipationActivityType' => '?',
            'App\\Form\\ParticipationEventType' => '?',
            'App\\Form\\PlatType' => '?',
            'App\\Form\\ProduitType' => '?',
            'App\\Form\\RateHotelType' => '?',
