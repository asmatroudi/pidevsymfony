 ...
 */
class getParticipationEventRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipationEventRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipationEventRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipationEventRepository.php';

        return $container->privates['App\\Repository\\ParticipationEventRepository'] = new \App\Repository\ParticipationEventRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
