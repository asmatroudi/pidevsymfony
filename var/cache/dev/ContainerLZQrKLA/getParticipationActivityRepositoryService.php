 ...
 */
class getParticipationActivityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParticipationActivityRepository' shared autowired service.
     *
     * @return \App\Repository\ParticipationActivityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParticipationActivityRepository.php';

        return $container->privates['App\\Repository\\ParticipationActivityRepository'] = new \App\Repository\ParticipationActivityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
