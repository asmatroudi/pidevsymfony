...
class __TwigTemplate_ce457af41938b49714cb0389f2b208b0 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 18
        ((twig_get_attribute($this->env, $this->source, (isset($context["commentaire"]) || array_key_exists("commentaire", $context) ? $context["commentaire"] : (function () { throw new RuntimeError('Variable "commentaire" does not exist.', 18, $this->source); })()), "dateajc", [], "any", false, false, false, 18)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["commentaire"]) || array_key_exists("commentaire", $context) ? $context["commentaire"] : (function () { throw new RuntimeError('Variable "commentaire" does not exist.', 18, $this->source); })()), "dateajc", [], "any", false, false, false, 18), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
            <tr>
                <th>Auteur</th>
    ...
    <a href=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_commentaire_edit", ["idcom" => twig_get_attribute($this->env, $this->source, (isset($context["commentaire"]) || array_key_exists("commentaire", $context) ? $context["commentaire"] : (function () { throw new RuntimeError('Variable "commentaire" does not exist.', 33, $this->source); })()), "idcom", [], "any", false, false, false, 33)]), "html", null, true);
        echo "\">edit</a>

    ";
        // line 35
        echo twig_include($this->env, $context, "commentaireAdmin/_delete_form.html.twig");
        echo "
";
    ...
    {
        return array (  122 => 35,  117 => 33,  112 => 31,  104 => 26,  97 => 22,  90 => 18,  83 => 14,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  36 => 1,);
    }
