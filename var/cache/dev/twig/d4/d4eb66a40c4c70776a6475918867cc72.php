...
class __TwigTemplate_557193e0bd7bfbb8a4bb69faa5b38ffe extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t<h5 style=\"margin-right: 0; margin-left: auto; color: #78b999;\">";
            // line 160
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["plat"], "recette", [], "any", false, false, false, 160), "html", null, true);
            echo "</h5>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div style=\"display: flex;\">
\t\t\t\t\t\t\t\t\t<span style=\"margin-left: 0; margin-right: auto;\">";
...
\t\t\t\t\t\t\t\t";
            // line 208
            ((twig_get_attribute($this->env, $this->source, $context["activity"], "date", [], "any", false, false, false, 208)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "date", [], "any", false, false, false, 208), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</p>
\t\t\t\t\t\t\t<p>
...
\t\t\t\t\t\t\t\t";
            // line 240
            ((twig_get_attribute($this->env, $this->source, $context["evenement"], "datev", [], "any", false, false, false, 240)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datev", [], "any", false, false, false, 240), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</h3>
\t\t\t\t\t\t\t<h4 class=\"consult-title\">";
            // line 241
...
\t\t\t\t\t\t\t\t<span style=\"color: #2f7c72;\" class=\"green\">On:
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t{{ activity.date ? activity.date|date('Y-m-d') : '' }}</p>
\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t<span style=\"color: #2f7c72;\" class=\"green\">Price:
\t\t\t\t\t\t\t\t</span>
\t\t\t\t\t\t\t\t{{ activity.price }}
...
\t\t\t\t\t\t\t\t|
\t\t\t\t\t\t\t\t{{ evenement.datev ? evenement.datev|date('Y-m-d') : '' }}</h3>
