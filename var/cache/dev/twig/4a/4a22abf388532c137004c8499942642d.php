...
class __TwigTemplate_3887317df0673346ba5c493875b64546 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 7
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 7, $this->source); })()), "recette", [], "any", false, false, false, 7), 'label', ["attr" => ["class" => "form-label"], "label" => "recette : "]);
        echo "
";
        // line 8
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 8, $this->source); })()), "recette", [], "any", false, false, false, 8), 'widget', ["attr" => ["class" => "form-control"]]);
        echo "
";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "recette", [], "any", false, false, false, 9), 'errors', ["attr" => ["class" => "form-control"]]);
        echo "
...
{{form_label(form.recette,'recette : ',{'attr':{'class':'form-label'}})}}
{{form_widget(form.recette,{'attr':{'class':'form-control'}})}}
{{ form_errors(form.recette,{'attr':{'class':'form-control'}}) }}
