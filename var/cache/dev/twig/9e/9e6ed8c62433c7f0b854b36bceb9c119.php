...
class __TwigTemplate_12098d0ed88d419507db71b2cfc6a406 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
            // line 156
            ((twig_get_attribute($this->env, $this->source, $context["evenement"], "datev", [], "any", false, false, false, 156)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["evenement"], "datev", [], "any", false, false, false, 156), "Y-m-d"), "html", null, true))) : (print ("")));
            echo "</h3>
