...
class __TwigTemplate_f10b2c106a40cc269fbb2ee13d5849eb extends Template
{
    private $source;
    private $macros = [];
...
{% block pagewrapper %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Datev</th>
                <td>{{ evenement.datev ? evenement.datev|date('Y-m-d') : '' }}</td>
            </tr>
            <tr>
                <th>Titre</th>
