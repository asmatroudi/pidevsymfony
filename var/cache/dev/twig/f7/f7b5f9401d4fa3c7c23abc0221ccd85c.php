...
class __TwigTemplate_72bd240860ef462f912d7af127e5db99 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('app_commande_delete', {'id': commande.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ commande.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "commande/_delete_form.html.twig", "C:\\Users\\Foura\\Desktop\\pidev\\Symfony\\prd2\\samar group\\last version\\tounesna\\templates\\commande\\_delete_form.html.twig");
    }
}
