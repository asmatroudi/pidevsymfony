...
class __TwigTemplate_350a190756feb526c714ff8e444171ec extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
            ...
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("/uploads/" . twig_get_attribute($this->env, $this->source, $context["produit"], "image", [], "any", false, false, false, 76))), "html", null, true);
            echo "\" alt=\"produit\">
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<!-- /.list-thumb -->
...
\t\t\t\t\t\t\t\t\t<h5 style=\"margin-left: 0; margin-right: auto;\">";
            // line 81
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "nomp", [], "any", false, false, false, 81), "html", null, true);
            echo "</h5>
\t\t\t\t\t\t\t\t\t<h5 style=\"margin-right: 0; margin-left: auto; color: #78b999;\">";
            // line 82
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "price", [], "any", false, false, false, 82), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t\t\tTND</h5>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div style=\"display: flex;\">
\t\t\t\t\t\t\t\t\t<span style=\"margin-left: 0; margin-right: auto;\">";
            // line 86
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["produit"], "type", [], "any", false, false, false, 86), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t\t<span style=\"margin-right: 0; margin-left: auto; color: #78b999;\">";
            // line 87
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["produit"], "gouvernorat", [], "any", false, false, false, 87), "nomGouver", [], "any", false, false, false, 87), "html", null, true);
            echo "</span>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t<div
...
\t\t\t\t\t\t\t\t\t";
            // line 92
            echo "\t\t\t\t\t\t\t\t\t<a style=\"margin-right: 0; margin-left: auto;\" href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add_panier", ["id" => twig_get_attribute($this->env, $this->source, $context["produit"], "idp", [], "any", false, false, false, 92)]), "html", null, true);
            echo "\" class=\"price-btn\">
...
\t";
    ...
    {
        return array (  272 => 105,  263 => 101,  248 => 92,  241 => 87,  237 => 86,  230 => 82,  226 => 81,  217 => 76,  212 => 70,  207 => 69,  199 => 64,  193 => 60,  186 => 59,  179 => 56,  174 => 53,  168 => 50,  162 => 47,  156 => 44,  150 => 41,  144 => 38,  138 => 35,  135 => 34,  128 => 33,  121 => 30,  116 => 27,  110 => 24,  104 => 21,  98 => 18,  92 => 15,  86 => 12,  80 => 9,  77 => 8,  70 => 7,  62 => 4,  55 => 3,  38 => 1,);
    }
...
\t<a style=\"margin: 50px 0 50px 200px;\" href=\"{{ path('app_commande_index') }}\" class=\"price-btn\">Mes Commandes</a>
\t<div class=\"middle-content\">
\t\t<div style=\"margin-bottom: 60px;\" class=\"container\">
\t\t\t<div class=\"row\">
\t\t\t\t<div class=\"our-listing owl-carousel\">
...
\t\t\t\t\t\t\t\t\t<a style=\"margin-right: 0; margin-left: auto;\" href=\"{{ path('add_panier', { 'id': produit.idp }) }}\" class=\"price-btn\">
\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-shopping-cart\"></i>
\t\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
