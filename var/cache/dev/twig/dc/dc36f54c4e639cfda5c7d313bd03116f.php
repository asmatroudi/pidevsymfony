...
class __TwigTemplate_2251346c174fa3a863f76a566db91bd4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "commentaire/_formCom.html.twig");
        echo "
...
{% block body %}
    ...
    {{ include('commentaire/_formCom.html.twig') }}

    <a href=\"{{ path('app_commentaire_index') }}\">back to list</a>
{% endblock %}
", "commentaire/new.html.twig", "C:\\Users\\Foura\\Desktop\\pidev\\Symfony\\prd2\\samar group\\last version\\tounesna\\templates\\commentaire\\new.html.twig");
    }
}
