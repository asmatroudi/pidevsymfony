...
class __TwigTemplate_0ef917ee69932f812b4f8a1d035eeaae extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <table class=\"table\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["gouvernorats"]) || array_key_exists("gouvernorats", $context) ? $context["gouvernorats"] : (function () { throw new RuntimeError('Variable "gouvernorats" does not exist.', 19, $this->source); })()));
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["gouvernorat"]) {
            ...
            echo "            <tr>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["gouvernorat"], "nomGouver", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["gouvernorat"], "region", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_gouvernorat_show", ["idGouver" => twig_get_attribute($this->env, $this->source, $context["gouvernorat"], "idGouver", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_gouvernorat_edit", ["idGouver" => twig_get_attribute($this->env, $this->source, $context["gouvernorat"], "idGouver", [], "any", false, false, false, 25)]), "html", null, true);
            echo "\">edit</a>
    ";
            // line 26
...
";
    ...
    {
        return array (  157 => 37,  152 => 34,  143 => 30,  126 => 26,  122 => 25,  118 => 24,  113 => 22,  109 => 21,  106 => 20,  88 => 19,  75 => 8,  68 => 7,  60 => 4,  53 => 3,  36 => 1,);
    }
