...
class __TwigTemplate_c377423bdbaaa04684cdb85843cec6c8 extends Template
{
    private $source;
    private $macros = [];
...
\t";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 60
        echo "
\t<div style=\"margin: 0 0 50px 0;\" class=\"page-top\" id=\"templatemo_services\"></div>
\t";
        // line 62
...
\t";
        ...
        echo "\" class=\"price-btn\">Mes Participations Activities</a>
\t<!-- /.page-header -->
...
\t\t\t\t";
        // line 189
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["activities"]) || array_key_exists("activities", $context) ? $context["activities"] : (function () { throw new RuntimeError('Variable "activities" does not exist.', 189, $this->source); })()));
...
\t\t\t\t\t\t\t\t<a href=\"#\">";
            // line 193
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "description", [], "any", false, false, false, 193), "html", null, true);
            echo "</a>
\t\t\t\t\t\t\t</h4>
\t\t\t\t\t\t\t<p>
...
\t\t\t\t\t\t\t\t";
            // line 198
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "adresse", [], "any", false, false, false, 198), "html", null, true);
            echo "</p>
\t\t\t\t\t\t\t<p>
\t\t\t\t\t\t\t\t<span style=\"color: #2f7c72;\" class=\"green\"></span>
\t\t\t\t\t\t\t\t";
            // line 201
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "type", [], "any", false, false, false, 201), "html", null, true);
            echo "</p>
\t\t\t\t\t\t\t<div style=\"margin: 20px 0;\" class=\"sample-thumb\">
\t\t\t\t\t\t\t\t<img src=\"";
            // line 203
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("/uploads/" . twig_get_attribute($this->env, $this->source, $context["activity"], "image", [], "any", false, false, false, 203))), "html", null, true);
...
\t\t\t\t\t\t\t\t";
            // line 209
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "numContact", [], "any", false, false, false, 209), "html", null, true);
            echo "</p>
\t\t\t\t\t\t\t<p>
...
\t\t\t\t\t\t\t\t";
            // line 213
            ((twig_get_attribute($this->env, $this->source, $context["activity"], "date", [], "any", false, false, false, 213)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "date", [], "any", false, false, false, 213), "d-m-Y"), "html", null, true))) : (print ("")));
            echo "</p>
\t\t\t\t\t\t\t<p>
...
\t\t\t\t\t\t\t\t";
            // line 217
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activity"], "price", [], "any", false, false, false, 217), "html", null, true);
            echo "
\t\t\t\t\t\t\t\tTND</p>
\t\t\t\t\t\t\t<a href=\"";
            // line 219
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_participation_activity_participer", ["id" => twig_get_attribute($this->env, $this->source, $context["activity"], "idActivity", [], "any", false, false, false, 219)]), "html", null, true);
            echo "\" class=\"ticket-btn\">Participer</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<!-- /.ticket-item -->
\t\t\t\t\t</div>
\t\t\t\t\t<!-- /.col-md-3 -->
...
";
    ...
    {
        return array (  305 => 230,  295 => 225,  284 => 219,  279 => 217,  272 => 213,  265 => 209,  256 => 203,  251 => 201,  245 => 198,  237 => 193,  232 => 190,  227 => 189,  220 => 184,  213 => 67,  204 => 64,  201 => 63,  197 => 62,  193 => 60,  186 => 59,  179 => 56,  174 => 53,  168 => 50,  162 => 47,  156 => 44,  150 => 41,  144 => 38,  138 => 35,  135 => 34,  128 => 33,  121 => 30,  116 => 27,  110 => 24,  104 => 21,  98 => 18,  92 => 15,  86 => 12,  80 => 9,  77 => 8,  70 => 7,  62 => 4,  55 => 3,  38 => 1,);
    }
...
\t\t</div>
\t{% endfor %}
\t<a style=\"margin: 50px 0 50px 200px;\" href=\"{{ path('app_participation_activity_index') }}\" class=\"price-btn\">Mes Participations Activities</a>
\t<!-- /.page-header -->
...
\t\t\t\t\t\t\t\t{{ activity.price }}
\t\t\t\t\t\t\t\tTND</p>
\t\t\t\t\t\t\t<a href=\"{{ path('app_participation_activity_participer', {'id': activity.idActivity}) }}\" class=\"ticket-btn\">Participer</a>
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<!-- /.ticket-item -->
\t\t\t\t\t</div>
\t\t\t\t\t<!-- /.col-md-3 -->
